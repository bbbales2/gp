...
state_z_0_1_1000 + geom_line(aes(time, z), color = "red", data=df_10) + geom_point(aes(time, z), color = "red", data=lorenz_df[[1]])
state_z_0_1_1000 + geom_line(aes(time, z), color = "red", data=df_20) + geom_point(aes(time, z), color = "red", data=lorenz_df[[2]])
state_z_0_1_1000 + geom_line(aes(time, z), color = "red", data=df_40) + geom_point(aes(time, z), color = "red", data=lorenz_df[[3]])
state_z_0_1_1000 + geom_line(aes(time, z), color = "red", data=df_80) + geom_point(aes(time, z), color = "red", data=lorenz_df[[4]])
state_z_0_1_1000 + geom_line(aes(time, z), color = "red", data=df_160) + geom_point(aes(time, z), color = "red", data=lorenz_df[[5]])
```
...
t <- draw_post_deriv_samples(hyperparam_draws[[2]], lorenz_df[[2]], tis = seq(0, 1, by = 0.01))

lorenz_df[[1]] %>% ggplot(aes(centered_time, dzdt)) + geom_point(color = "red") + geom_line(aes(time, value, group = sample), alpha = 0.05, data = t) + geom_line(aes(centered_time, dzdt),data = df_1000, color = "green")
```
